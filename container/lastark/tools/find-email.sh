...
ldapsearch -l 5 -o ldif-wrap=no -E pr=10000/noprompt -z 0 -d 256 -H $AD_LDAP_URI -b "$AD_LDAP_SEARCHBASE" -D "$AD_LDAP_BINDDN" -x -w "$AD_LDAP_BINDPASSWD" "CN=$USER" 'mail' | grep 'mail: ' | sed 's/mail: //g'
